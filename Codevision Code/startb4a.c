...
delay_ms(20000); // wait for SIM800 startup

printf("ATE0");
putchar(13);
putchar(10);     
delay_ms(500); // wait for establishing connection to irancell network
...
printf("AT+SAPBR=3,1,APN,mtnirancell");
putchar(13);
putchar(10);
delay_ms(500);
...
PORTC.2=1; // Please delete it later!

printf("AT+HTTPPARA=URL,195.182.38.151/polls/last_state");
putchar(13);
putchar(10);
delay_ms(500);
